    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-36 justify-around items-center mb-20 p-5 md:p-0">
            <div className="w-[470px] h-[355px] mb-24 md:mb-0">
                ...
                ></SectionTitle>
                <p className="p-5 md:p-0">We are proud to be a trusted healthcare provider in our community, and we look forward to serving you and your family with excellence, integrity, and compassion. Your health is our priority, and we are here for you every step of the way. We believe in treating each patient with dignity, respect, and empathy, ensuring that they receive the attention and care they deserve. </p>
